                            ...
                            <div class="card">
                                <div class="card-body"> 
                                    <div class="row" style="margin-bottom:24px">
                                        <div class="col-lg-6 weight60020">Edit Pengguna Baru</div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <form class="user" id="submitPosition" method="post" action="{{url('pengguna/update/'.$detail->id)}}">
                                            @csrf
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div>
                                                            <input type="text" name="username" required class="form-control"
                                                                placeholder="Masukkan Username" value="{{ $detail->username }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        Nama
                                                        <div>
                                                            <input type="text" name="nama" required class="form-control"
                                                                placeholder="Masukkan Nama" value="{{ $detail->nama_depan }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div>
                                                            <input type="email" name="email" required class="form-control"
                                                                placeholder="Masukkan Email" value="{{ $detail->email }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        Jabatan
                                                        <div>
                                                            <select name="jabatan" required class="form-control"
                                                                ...
                                                                <option <?php ($detail->position_id == $jb->id)?"selected":"";?> value="{{ $jb->id.'|'.$jb->name }}">{{ $jb->name }}</option>
                                                                <?php endforeach;?>
                                                            </select>
                                                        </div>
                                                    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#submitPosition').submit(function(event) {
                ...
                $.ajax({
                url: '{{url("pengguna/update/".$detail->id)}}', // Laravel route for form submission
                method: 'POST',
