                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            ...
                                            <div class="login-welcome text-gray-900">Selamat Datang di CMS SIGAP PANGAN</div>
                                            <div class="mb-4">Tolong masukan informasi akun mu untuk fitur yang lebih banyak dari biasanya.</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-3"></div>
                                            <div class="col-lg-6">
                                                @error('gagal')
                                                    <span class="text-red-500">{{ $message }}</span> <!-- Display error message -->
                                                @enderror
                                                @if (session('success'))
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-icons">
                                                            ...
                                                            <input type="password" name="password" class="form-control form-login"
                                                                id="exampleInputPassword" required aria-describedby="passwordHelp"
