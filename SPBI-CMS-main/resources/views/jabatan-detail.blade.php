                            ...
                            <div class="card">
                                <div class="card-body"> 
                                    <div class="row" style="margin-bottom:24px">
                                        <div class="col-lg-6 weight60020">Detail Jabatan</div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <form class="user">
                                                <div class="form-group">
                                                    Nama Jabatan
                                                    <div>
                                                        <input style="width:40%" type="text" readonly value="{{$data->name}}" class="form-control"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="margin-10"><input type="checkbox" name="menu[]" value="{{$datamenu->id}}" disabled <?php echo in_array($datamenu->name, $privileges)?"checked":""; ?> class="menu" required> {{$datamenu->name}}</span>
                                                        @endforeach
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="float-right">
                                                    <a href="{{url('jabatan')}}" type="button" class="btn btn-outline-secondary btn-save-custom">
                                                        Kembali
                                                    </a>
                                                    <?php /*
                                                    <button data-toggle="modal" data-target="#successModal" type="button" class="btn btn-primary btn-custom-primary btn-save-custom">
                                                        Simpan
                                                    </button>*/?>
                                                </div>
                                            </form>
