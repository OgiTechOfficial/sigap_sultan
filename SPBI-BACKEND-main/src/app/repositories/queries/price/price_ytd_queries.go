...
const (
						...
						JSON_BUILD_OBJECT(
							'higher', (
								...
								FROM price_inflation(
									...
									TO_CHAR(minus_1_year(TO_DATE(@selectedDate, 'YYYY-MM-DD')::TEXT), 'YYYY-12-01'),
									TO_CHAR(minus_1_year(TO_DATE(@selectedDate, 'YYYY-MM-DD')::TEXT), 'YYYY-12-31')
								)
								WHERE inflation > 0
							),
							'same', (
									...
									CASE 
										WHEN (
											SELECT price_province_inflation(
												...
												TO_CHAR(minus_1_year(TO_DATE(NOW()::TEXT, 'YYYY-MM-DD')::TEXT), 'YYYY-12-01'),
												TO_CHAR(minus_1_year(TO_DATE(NOW()::TEXT, 'YYYY-MM-DD')::TEXT), 'YYYY-12-31')
										   )
										) > 0
										THEN 'higher'
										WHEN (
	...
	PriceGetYtdListWithOrderAvgChild = `
			SELECT
				(
					SELECT JSON_BUILD_OBJECT(
						'id', a.id,
	...
	PriceGetYtdListWithOrderDescAvgChild = `
			SELECT
				(
					SELECT JSON_BUILD_OBJECT(
						'id', a.id,
	...
	PriceGetYtdCityHistoryAvgChild = `
			SELECT
				(
					SELECT
						JSON_BUILD_OBJECT(
	...
	PriceGetYtdCityHistoryProvince = `
			SELECT
				(
					SELECT
						JSON_BUILD_OBJECT(
...
-- 				) city,
	...
	PriceGetYtdCityHistoryProvinceAvgChild = `
			SELECT
				(
					SELECT
						JSON_BUILD_OBJECT(
	...
	PriceGetYtdCommodityHistoryHigher = `
			SELECT
				(
					SELECT
						JSON_BUILD_OBJECT(
	...
	PriceGetYtdCommodityHistoryHigherAvgChild = `
			SELECT
				(
					SELECT
						JSON_BUILD_OBJECT(
	...
	PriceGetYtdCommodityHistorySame = `
			SELECT
				(
					SELECT
						JSON_BUILD_OBJECT(
	...
	PriceGetYtdCommodityHistorySameAvgChild = `
			SELECT
				(
					SELECT
						JSON_BUILD_OBJECT(
	...
	PriceGetYtdCommodityHistoryLower = `
			SELECT
				(
					SELECT
						JSON_BUILD_OBJECT(
	...
	PriceGetYtdCommodityHistoryLowerAvgChild = `
			SELECT
				(
					SELECT
						JSON_BUILD_OBJECT(
