import {
  priceMTMApi,
  PriceMTMCommodityHistoryRequest,
...
function MTMPerCityTableModal(props: Props) {
    ...
    useQuery({
      ...
      queryFn: async () => {
        const { result, error, displayMessage } =
          await priceMTMApi.getPriceMTMCommodityHistory({
            ...
            selectedDate: priceTableState.date
              ...
              : "",
          } as PriceMTMCommodityHistoryRequest);
...
export default MTMPerCityTableModal;
