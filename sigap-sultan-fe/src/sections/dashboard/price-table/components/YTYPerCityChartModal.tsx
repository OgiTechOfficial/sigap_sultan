...
function YTYPerCityChartModal(props: Props) {
  const {
    title,
    opened,
    close,
    ...
    useQuery({
      ...
      queryFn: async () => {
        ...
        const { result, error, displayMessage } =
          await priceYTYApi.getPriceYTYCityHistory({
...
export default YTYPerCityChartModal;
