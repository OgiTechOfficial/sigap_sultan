...
function YTDPerCityChartModal(props: Props) {
  const {
    title,
    opened,
    close,
    ...
    useQuery({
      ...
      queryFn: async () => {
        ...
        const { result, error, displayMessage } =
          await priceYTDApi.getPriceYTDCityHistory({
...
export default YTDPerCityChartModal;
