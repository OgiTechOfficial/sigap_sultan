import {
  priceYTDApi,
  PriceYTDCommodityHistoryRequest,
} from "@/api/base/price/priceYTD";
...
function YTDPerCityTableModal(props: Props) {
    ...
    useQuery({
      ...
      queryFn: async () => {
        const { result, error, displayMessage } =
          await priceYTDApi.getPriceYTDCommodityHistory({
            ...
            selectedDate: priceTableState.date
              ...
              : "",
          } as PriceYTDCommodityHistoryRequest);
...
export default YTDPerCityTableModal;
