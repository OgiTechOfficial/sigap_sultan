...
import YTYPerCityTableModal from "./components/YTYPerCityTableModal";
import YTYPerCityChartModal from "./components/YTYPerCityChartModal";
import { PricePerCityData } from "@/types/pricePerCityMap";
import { PriceTableState } from "./components/PriceTableFilter";
import usePriceChangeYTY from "./hooks/usePriceChangeYTY";
...
function PriceChangeYTY(props: Props) {
  ...
  const {
    ...
    dataPriceLevelMap,
    dataPriceLevelList,
  } = usePriceChangeYTY(priceTableState, sortBy);
    ...
    <>
      ...
      <Grid>
        <Grid.Col span={{ sm: 12, md: 3 }}>
          ...
          <Text size="xs" mb="md">
            Year To Year adalah perubahan rata-rata harga pada bulan berjalan
