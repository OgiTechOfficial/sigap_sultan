...
import MTMPerCityChartModal from "./components/MTMPerCityChartModal";
import MTMPerCityTableModal from "./components/MTMPerCityTableModal";
...
import usePriceChangeMTM from "./hooks/usePriceChangeMTM";
...
function PriceChangeMTM(props: Props) {
  ...
  const {
    ...
    dataPriceLevelList,
    dataPriceLevelMap,
  } = usePriceChangeMTM(priceTableState, sortBy);
    ...
    <>
      ...
      <Grid>
        <Grid.Col span={{ sm: 12, md: 3 }}>
          ...
          <Text size="xs" mb="md">
            Month To Month adalah perubahan rata-rata harga pada bulan berjalan
