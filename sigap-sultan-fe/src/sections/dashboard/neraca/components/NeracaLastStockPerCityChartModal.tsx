...
function NeracaLastStockPerCityChartModal(props: Props) {
    ...
    useQuery({
      ...
      queryFn: async () => {
        ...
        const { result, error, displayMessage } =
          await neracaApi.getNeracaLastStockCityHistory({
...
export default NeracaLastStockPerCityChartModal;
