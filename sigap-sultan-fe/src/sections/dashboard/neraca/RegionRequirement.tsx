...
import useRequirementRegion from "./hooks/useRequirementRegion";
...
function RegionRequirement(props: Props) {
  const { neracaState } = props;
  const { dataLastStockCityMap, isLoading } = useRequirementRegion(neracaState);
...
export default RegionRequirement;
